...
<div class="container-fluid">
    ...
    >
        ...
        <template v-slot:footer>
            <button class="btn btn-danger" @click="delete_car_tracker()">Delete</button>
        </template>
    </modal_window>
</div>
</template>
...
const update_car_tracker = inject("update_car_tracker");
...
function save_changes() {
    ...
    axios
        .patch("/api/v1/cartracker/" + route.params.device_id + "/", request_data)
        .then(() => {
...
function delete_car_tracker() {
    axios
        .delete("/api/v1/cartracker/" + route.params.device_id + "/")
        .then(() => {
